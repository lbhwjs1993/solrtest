package com.sankuai.web.Utils;

import com.sankuai.web.domain.User;
...
public class SolrUtils {
    ...
    public void addDoc() throws SolrServerException, IOException {
        ...
        document.addField("name", "li");
        document.addField("description", "一个灰常牛逼的画家");
        document.addField("sex", "男");
        //获得一个solr服务端的请求，去提交  ,选择具体的某一个solr core
        HttpSolrClient solr = new HttpSolrClient.Builder(SOLR_URL + "mycollextion").withConnectionTimeout(10000).withSocketTimeout(60000).build();
        solr.add(document);
        solr.commit();
        solr.close();
    }
    ...
    public void deleteDocumentById() throws Exception {
        //选择具体的某一个solr core
        HttpSolrClient server = new HttpSolrClient.Builder(SOLR_URL + "mycollextion").withConnectionTimeout(10000).withSocketTimeout(60000).build();
        //删除文档
        server.deleteById("8");
        //删除所有的索引
        //solr.deleteByQuery("*:*");
    ...
    public void querySolr() throws Exception {
        HttpSolrClient solrServer = new HttpSolrClient.Builder(SOLR_URL + "mycollextion/").withConnectionTimeout(10000).withSocketTimeout(60000).build();
